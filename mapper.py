...
CT_NONE = _mapper.CT_NONE
CT_MUTE = _mapper.CT_MUTE
CT_CLAMP = _mapper.CT_CLAMP
CT_FOLD = _mapper.CT_FOLD
CT_WRAP = _mapper.CT_WRAP
N_MAPPER_CLIPPING_TYPES = _mapper.N_MAPPER_CLIPPING_TYPES
...
class signal(_object):
    ...
    def set_query_callback(self, PyFunc=None): return _mapper.signal_set_query_callback(self, PyFunc)
    def query_remotes(self): return _mapper.signal_query_remotes(self)
...
class monitor(_object):
    ...
    def request_signals_by_name(self, *args): return _mapper.monitor_request_signals_by_name(self, *args)
    def request_links_by_name(self, *args): return _mapper.monitor_request_links_by_name(self, *args)
    def request_connections_by_name(self, *args): return _mapper.monitor_request_connections_by_name(self, *args)
